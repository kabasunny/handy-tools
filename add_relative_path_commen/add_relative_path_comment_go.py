# add_relative_path_commen\add_relative_path_comment_go.py
import os


def add_relative_path_to_go_files(root_dir, target_dir):
...
if __name__ == "__main__":
    ...
    add_relative_path_to_go_files(project_root, target_directory)
